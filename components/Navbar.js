...
const Navbar = () => {
  return (
  <nav className='w-full h-[70px] bg-gradient-to-r from-green-800 via-yellow-600 to-black-800 items-center justify-between px-12 py-2 pt-2'>
            ...
            <div className=' hidden md:flex justify-between'>
               ...
               <Link href='checkout'> 
                <Button className='px-16 py-2 bg-black rounded-b-sm p-4 text-slate-700'  >
                    <span className='text-shadow-white font-extrabold text-md text-white'>0</span>
